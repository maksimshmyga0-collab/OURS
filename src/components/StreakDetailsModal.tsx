...
export const StreakDetailsModal: React.FC<StreakDetailsModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-white border border-[#EBE3E5] rounded-t-[28px] sm:rounded-[24px] p-6 pb-8 shadow-[0_-4px_28px_rgba(0,0,0,0.08)] max-h-[90vh] overflow-y-auto no-scrollbar animate-in slide-in-from-bottom-4 sm:zoom-in-[0.98] duration-300 ease-out"
