...
export const PhotoPickerModal: React.FC<PhotoPickerModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-white dark:bg-[#111111] border border-[#EBE3E5] dark:border-[#242024] rounded-t-[28px] sm:rounded-[24px] p-6 pb-8 shadow-[0_-4px_28px_rgba(0,0,0,0.12)] max-h-[85vh] overflow-y-auto no-scrollbar animate-in slide-in-from-bottom-4 sm:zoom-in-[0.98] duration-250 ease-out transition-colors"
      ...
      >
        ...
        {/* Clean Empty State Preview Frame (No test/mock photos) */}
        <div className="w-full aspect-[4/3] rounded-[22px] border-2 border-dashed border-[#E5D7DA] dark:border-[#2E282E] bg-[#FAF5F7] dark:bg-[#161416] flex flex-col items-center justify-center p-6 text-center mb-5">
        ...
        <div className="space-y-2.5">
          ...
          <button
            ...
            className="w-full min-h-[50px] rounded-[18px] bg-[#E98787] hover:bg-[#DE7777] active:bg-[#D56868] text-white font-semibold text-sm flex items-center justify-center gap-2.5 transition-all active:scale-[0.98] cursor-pointer shadow-xs"
          >
            <Camera size={18} />
          ...
          <button
            ...
            className="w-full min-h-[50px] rounded-[18px] bg-[#FAF0F2] dark:bg-[#1C1719] hover:bg-[#F6E6E9] dark:hover:bg-[#231C1F] text-[#343033] dark:text-white font-semibold text-sm flex items-center justify-center gap-2.5 transition-all active:scale-[0.98] cursor-pointer border border-[#EED7DC] dark:border-[#35252A]"
          >
