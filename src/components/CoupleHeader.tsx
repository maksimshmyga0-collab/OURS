...
export const CoupleHeader: React.FC<CoupleHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#FFF9FA]/92 dark:bg-[#000000]/92 backdrop-blur-xl border-b border-[#000000]/6 dark:border-[#242024] px-3.5 sm:px-4 h-[52px] sm:h-[56px] grid grid-cols-[1fr_auto_1fr] items-center transition-colors">
